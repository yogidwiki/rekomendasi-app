  ...
  <div class="row d-flex justify-content-between mb-5">
    ...
    <div class="col-md-2">
        <div class="dropdown mt-3">
            <button class="btn btn-login btn-success dropdown-toggle w-100 d-block" type="button" data-bs-toggle="dropdown">
                Kategori
            </button>
    ...
    <div class="col-md-4">
        <div class="input-group mt-3">
            ...
            <button class="btn btn-login btn-success" type="button">Cari</button>
        </div>
    </div>
</div>
