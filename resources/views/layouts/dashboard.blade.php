            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->is('makanan') ? 'active' : '' }}">
                        <a href="{{ route('makanan.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-food-menu"></i>
                            <!-- Ikon yang lebih sesuai untuk Makanan -->
                            <div data-i18n="Boxicons">Makanan</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('imunisasi') ? 'active' : '' }}">
                        <a href="{{ route('imunisasi.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-heart"></i> <!-- Ikon yang sesuai untuk Imunisasi -->
                    ...
                    <li class="menu-item {{ request()->is('categories', 'articles') ? 'active' : '' }}">
                        <a href="javascript:void(0)" class="menu-link menu-toggle">
                            ...
                            <!-- Ikon yang sesuai untuk Artikel -->
                    ...
                    <li class="menu-item {{ request()->is('rules') ? 'active' : '' }}">
                        <a href="{{ route('rules.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-list-check"></i> <!-- Ikon yang sesuai untuk Aturan -->
