                        ...
                        @auth
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false" onclick="markAllAsRead()">
                                    Notifikasi
                                    @if ($notifications->whereNull('read_at')->count() > 0)
                                        <span
                                            class="badge bg-danger ms-2">{{ $notifications->whereNull('read_at')->count() }}</span>
                                    @endif
                                </a>
                                    ...
                                    @forelse ($notifications->whereNull('read_at') as $notification)
                                        <li class="notification-item unread">
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="notification-icon bg-primary text-white rounded-circle d-flex justify-content-center align-items-center me-2"
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-md-8 text-center">
                    ...
                    <hr>
                    <a href="#" class="nav-link mb-3 text-aqua">&copy; 2024 Sistem Monitoring Tumbuh kembang balita Balita.
                        Semua hak dilindungi</a>
                </div>
            </div>
        </div>
    </footer>
