    ...
    <div class="container my-5 p-4 min-vh-100">
        ...
        @if ($makanan->isEmpty())
            <div class="text-center">
                <img src="https://img.freepik.com/premium-vector/hand-drawn-no-data-illustration_23-2150696443.jpg?size=338&ext=jpg&ga=GA1.1.2008272138.1721606400&semt=ais_user" alt="">
                ...
                @foreach ($makanan as $m)
                    <div class="col-md-12 my-4">
                        <div class="card shadow border-primary rounded-4">
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="{{ asset('makanan-images/' . $m->gambar) }}" class="card-img-top rounded-4 m-4" alt="{{ $m->nama_makanan }}">
                                </div>
                                <div class="col-md-8">
